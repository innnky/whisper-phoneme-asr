    ...
    for batch_idx, (x, x_lengths, lang, spec, spec_lengths, y, y_lengths, sid) in enumerate(train_loader):
        ...
        with autocast(enabled=hps.train.fp16_run):
            ...
            with autocast(enabled=False):
                ...
                loss_kl = kl_loss(z_p, logs_q, m_p, logs_p, tot_log_det, z_mask) * hps.train.c_kl

                loss_fm = feature_loss(fmap_r, fmap_g)
                loss_gen, losses_gen = generator_loss(y_d_hat_g)
                c_style = 0 if global_step < 10000 else (0.01 if global_step < 20000 else 0.1)
            ...
            if global_step % hps.train.log_interval == 0:
                ...
                scalar_dict.update(
                    {"loss/g/fm": loss_fm, "loss/g/mel": loss_mel, "loss/g/dur": loss_dur,
                     "loss/g/kl": loss_kl, "loss/g/style_kl": style_loss_kl, "loss/g/style_rec": style_loss_rec})
